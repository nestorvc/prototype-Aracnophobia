package 
{
	...
	public class BoxDebris extends FlxEmitter
	{
		//Image source for the debris sprite
		[Embed(source='/assets/sprites/gibs2.png')] private var ImgDebris:Class;
		...
		public function BoxDebris(X:Number=0, Y:Number=0, Size:Number=0)
		{
			super(X, Y, Size);		
